...
class HungarianMatcher(nn.Module):
    ...
    def __init__(self, cost_class: float = 1, cost_mask: float = 1, cost_dice: float = 1, 
                 cost_param: float = 1, cost_depth: float = 1,  cost_center: float = 1, 
                 predict_param: bool = True, predict_depth: bool = True, 
                 predict_center: bool = True, num_points: int = 0):
        """Creates the matcher
    ...
    def memory_efficient_forward(self, outputs, targets):
        ...
        for b in range(bs):
            ...
            if self.predict_center:
                ...
                C += self.cost_center * cost_center

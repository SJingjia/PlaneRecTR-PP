...
def add_PlaneRecTR_config(cfg):
    ...
    cfg.MODEL.MASK_FORMER.TEST.PLANE_SCORE_THRESHOLD = 0.6
    cfg.MODEL.MASK_FORMER.TEST.MASK_PROB_THRESHOLD = 0.5
    cfg.MODEL.MASK_FORMER.TEST.OVERLAP_THRESHOLD = 0.6
    ...
    cfg.INPUT.DATA_MULTIVIEWS = False
    ...
    cfg.MODEL.MASK_FORMER.TEST.OUTPUTDIR_FOR_RESULTS = None
    cfg.MODEL.MASK_FORMER.TEST.SAVE_OUTPUT =  False
    ...
    cfg.MODEL.CAMERA_MODULE.CAMERA_DECODER_NAME = "ViTEss"
    cfg.MODEL.CAMERA_MODULE.NOESS = False
    cfg.MODEL.CAMERA_MODULE.NO_POS_ENCODING = True
    cfg.MODEL.CAMERA_MODULE.CROSS_FEATURES = False
    cfg.MODEL.CAMERA_MODULE.USE_SINGLE_SOFTMAX = False
    cfg.MODEL.CAMERA_MODULE.L1_POS_ENCODING = False
    cfg.MODEL.CAMERA_MODULE.FC_HIDDEN_SIZE = 512 #? pose_regressor hidden size
    cfg.MODEL.CAMERA_MODULE.TRANSFORMER_DEPTH = 1
    cfg.MODEL.CAMERA_MODULE.FUSION_TRANSFORMER = True
    cfg.MODEL.CAMERA_MODULE.NUM_HEADS = 4 
    cfg.MODEL.CAMERA_MODULE.POSE_TR_WEIGHT = 10.0
    cfg.MODEL.CAMERA_MODULE.POSE_ROT_WEIGHT = 10.0
    cfg.MODEL.CAMERA_MODULE.PREDICT_INVERSE_POSES = False
    cfg.MODEL.CAMERA_MODULE.INVERSE_POSE_TR_WEIGHT = 2.5
    cfg.MODEL.CAMERA_MODULE.INVERSE_POSE_ROT_WEIGHT = 7.5
    cfg.MODEL.CAMERA_MODULE.PREDICT_JOINT_CORR_POSE_PARAM = False
    cfg.MODEL.CAMERA_MODULE.PREDICT_JOINT_GTCORR_POSE_GTPARAM = False
    cfg.MODEL.CAMERA_MODULE.PREDICT_JOINT_01CORR_POSE_PARAMDETACH = False
    cfg.MODEL.CAMERA_MODULE.JOINT_CORR_POSE_PARAM_L1_WEIGHT = 3.0
    cfg.MODEL.CAMERA_MODULE.JOINT_CORR_POSE_PARAM_COS_WEIGHT = 3.0
    cfg.MODEL.CAMERA_MODULE.JOINT_GTCORR_POSE_GTPARAM_L1_WEIGHT = 3.0
    cfg.MODEL.CAMERA_MODULE.JOINT_GTCORR_POSE_GTPARAM_COS_WEIGHT = 5.0
    cfg.MODEL.CAMERA_MODULE.JOINT_01CORR_POSE_PARAMDETACH_OFFSET_WEIGHT = 3.0
    cfg.MODEL.CAMERA_MODULE.JOINT_01CORR_POSE_PARAMDETACH_COS_WEIGHT = 5.0
    cfg.MODEL.CAMERA_MODULE.CORRS_WEIGHT = 0.2
    cfg.MODEL.CAMERA_MODULE.DECOUPLING = 0
    cfg.MODEL.CAMERA_MODULE.PHASE2_TFM = False
    cfg.MODEL.CAMERA_MODULE.PARAM_ENCODING = False
    cfg.MODEL.CAMERA_MODULE.CENTER_ENCODING = False
    cfg.MODEL.CAMERA_MODULE.PREDICT_CORRS = False
    cfg.MODEL.CAMERA_MODULE.FILTER_CAM_PLANES = False
    cfg.MODEL.CAMERA_MODULE.ATTN1_TRANSPOSE = False
    cfg.MODEL.CAMERA_MODULE.ATTN2_TRANSPOSE = False
    cfg.MODEL.CAMERA_MODULE.MASK_EMBEDDINGS = False
    cfg.MODEL.CAMERA_MODULE.CONSISTENT_MLP_LAYERS = 0
    cfg.MODEL.CAMERA_MODULE.CROSS_PP_EMBEDDING = False
    cfg.MODEL.CAMERA_MODULE.MASK2CENTER = False
    cfg.MODEL.CAMERA_MODULE.ONE_HEAD_KQ = True
    cfg.MODEL.CAMERA_MODULE.TEST = CN()
    cfg.MODEL.CAMERA_MODULE.TEST.FILTER_CORR_PLANES = True
    cfg.MODEL.CAMERA_MODULE.TEST.MATCH_THRESHOLD = 0.2
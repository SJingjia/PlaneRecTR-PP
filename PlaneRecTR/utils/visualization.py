...
def create_instances(segmenation, score, image_size, pred_planes=None, conf_threshold=0.7):
    ...
    labels = np.asarray([1 for i in chosen])
    ...
    try:
        ret.pred_masks = [s for s in segmenation[chosen]]
    except:
        pass
    return ret
...
def get_labeled_seg(
    ...
    if paper_img:
        # boxes = None
        labels = None
    assigned_colors = [[172 / 255., 114 / 255., 82 / 255. ],  # chair
                       [1., 1., 1.],  # pic white
    ...
    # assigned_colors = [[226/255., 107/255., 10/255.],
    #                    [0/255., 192/255., 255/255.],
    #                    [146 / 255., 111 / 255., 194 / 255.],
    #                    [92 / 255., 193 / 255., 61 / 255.],
    #                    [78 / 255., 71 / 255., 183 / 255.],
    #                    [172 / 255., 114 / 255., 82 / 255.],
    #                    [79 / 255., 129 / 255., 189 / 255.],
    #                    [238 / 255., 236 / 255., 225 / 255.],
    #                    [166/255., 56/255., 124/255.],
    #                    [11/255., 163/255., 51/255.],
